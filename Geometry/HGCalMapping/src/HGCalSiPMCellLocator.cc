...
int HGCalSiPMCellLocator::getSiPMchannel(int seq, int econderx, int halfrocch) const
{
...
std::tuple<int,int> HGCalSiPMCellLocator::getCellLocation(const HGCalElectronicsId& id, int seq, int layer, int modiring, int modiphi) const
{
